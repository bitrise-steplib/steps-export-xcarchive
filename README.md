...
| `product` | Describes which product to export. (Not needed for app-store distribution.)  For app-store distribution both the main App and the App Clip are included in the IPA, regardless of this setting. | required | `app` |
